...
export const demoConversations: Conversation[] = [
  {
    id: 'design-team',
    user: { id: 'maya', name: 'Maya Chen', initials: 'MC', presence: 'online' },
    unreadCount: 0,
  ...
  {
    id: 'sam-lee',
    user: { id: 'sam', name: 'Sam Lee', initials: 'SL', presence: 'online' },
    unreadCount: 2,
  ...
  {
    id: 'harper-jones',
    user: { id: 'harper', name: 'Harper Jones', initials: 'HJ', presence: 'away' },
    unreadCount: 0,
  ...
  {
    id: 'project-alpha',
    user: { id: 'alex', name: 'Alex Morgan', initials: 'AM', presence: 'offline', lastSeen: 'last seen yesterday' },
    unreadCount: 0,
